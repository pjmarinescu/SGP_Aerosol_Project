...
df_120M = pickle.load(open(savepath+"df_1440M_FnvFinal_D2E4_var95_LT2wk18_CPCQC_medpctdif.p","rb"))
df_120M = df_120M[0]
...
dfc_1440M = pickle.load(open(savepath+"df_1440M_FnvFinal_D2E4_var95_LT2wk18_CPCQC_medpctdif.p","rb"))
dfc_1440M = dfc_1440M[0]
#Fill data points that are missing three points in a row
